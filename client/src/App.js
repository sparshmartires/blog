...
import Superposts from './pages/Superadminposts';
    ...
    return (
      <Router>
        <div className="App">
          ...
          <NavigationBar isLoggedIn={isLoggedIn} isAdmin={isLoggedIn && this.state.user.role==='admin'} isSuperAdmin={isLoggedIn && this.state.user.role==='superadmin'}/>
          ...
          <Switch>
            ...
            }
            {
             ...
             {
              isLoggedIn && this.state.user.role === 'superadmin' &&
              <Route path="/approvepost" exact component={Superposts} />
            }
            {
              isLoggedIn && this.state.user.role === 'superadmin' &&
              <Route path="/addusers" exact component={CreateUser} />
            }
            {
